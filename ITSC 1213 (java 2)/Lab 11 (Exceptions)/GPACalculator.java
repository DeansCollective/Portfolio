...
public class GPACalculator {
        ...
        while (quitCmd != 'q') {
            try {
                ...
                try {
                    ...
                    // consume the new line from the last nextInt call
                    scnr.nextLine();
                    throw new Exception("Invalid type entered. Please try again!");
                }
            ...
            // Prompt user to continue entering grade or quit
    ...
    private static double computeGPA(int qualityPoints, int ceditHours) throws ArithmeticException {
        if (ceditHours == 0) {
