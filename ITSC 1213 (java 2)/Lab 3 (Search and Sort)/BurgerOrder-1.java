...
public class BurgerOrder {
    ...
    public int getNumHamburger() { //getter
        return this.numHamburgers;
    }
    public void setNumHamburger(int num) { //setter. Setters dont return a value.
        if (numHamburgers > 0) {
    ...
    public int totalBurgers(){
    return numCheeseburgers + numVeggieburgers + numHamburgers;
    }
}
