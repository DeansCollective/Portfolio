...
public class main {
    public static void main(String[] args) {
        ...
        */
        ...
        BurgerOrder order1 = new BurgerOrder(2, 5, 3, 4, false, 1);
        BurgerOrder order2 = new BurgerOrder(60, 6, 4, 10, false, 2);
        BurgerOrder order3 = new BurgerOrder(3, 7, 4, 10, false, 3);
