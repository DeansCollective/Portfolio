/**
By using the classes Person, Student, and Professor, this application demonstrates how to keep track of academic records for persons and their connections.
@author Dean
*/
import java.util.*;
