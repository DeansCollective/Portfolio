...
public class Main {
    ...
    //    System.out.println("**** Part C ****");
        ...
        System.out.println(s0.equals(s4)); // should return false
        Student s5 = new Student("Xavier", "Cato", 900111222, "CS", 3.5, 75);
        System.out.println(s0.equals(s5)); // should return true
        System.out.println(s0.equals(prof0)); // should return false
