...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PetStore ps = new PetStore("Dean Shop");
        ...
        while (true) {
            ...
            switch (choice1) {
                ...
                case 3:
                    System.out.println("------------------------------------");
                    ArrayList<Pet> addList = new ArrayList<>();
                    String name;
                    String breed;
                    String sex;
                    double weight;
                    ...
                    for (int i = 0; i < x; i++){
                    System.out.println(x);
                    System.out.println("What type of pet do you want to add? Press one for dog, two for cat, three for exotic!");
                int y = scnr.nextInt();
                if (y == 1) {
                    ...
                    breed = scnr.nextLine();
                    System.out.println("What is the sex?");
                    sex = scnr.nextLine();
                    ...
                    Dog addDog = new Dog(name, breed, sex, age, weight, id, price);
                    addList.add(addDog);
                } else if (y == 2) {
                    System.out.println("name?");
                    scnr.nextLine();
                    ...
                    System.out.println("price?");
                    price = scnr.nextDouble();
                    Cat addCat = new Cat(name, breed, sex, age, weight, id, price);
                    addList.add(addCat);
                    }
                    if (y == 3) {
                    System.out.println("Name?");
                    ...
                    String speciesOf = scnr.nextLine();
                    System.out.println("What is the sex?");
                    sex = scnr.nextLine();
                    System.out.println("age?");
                    age = scnr.nextInt();
                    ...
                    System.out.println("price?");
                    price = scnr.nextDouble();
                    ExoticPet addExoticPet = new ExoticPet(name, speciesOf, sex, age, weight, id, price);
                    addList.add(addExoticPet);
                    }
                    ps.adoptionDrive(addList);
                    }

                    break;
                case 4:
                    ps.display();
                    System.out.println("Enter the pets that you want to compare separately.");
                    int number1 = scnr.nextInt() - 1;
                    int number2 = scnr.nextInt() - 1;
                    ArrayList<Pet> compareList = new ArrayList<>();
                    compareList = ps.getAvailablePets();
                    double price1 = 0;
                    double price2 = 0;
                    for (Pet pet : compareList) {
                        if (compareList.indexOf(pet) == number1) {
                            price1 = pet.getPrice();
                        } else if (compareList.indexOf(pet) == number2) {
                            price2 = pet.getPrice();
                        }
                    }
                    if (price1 > price2) {
                        System.out.println("Pet " + (number1 + 1) + " is more expensive than Pet " + (number2 + 1) + " by $" + (price1 - price2));
                    } else if (price2 > price1) {
                        System.out.println("Pet " + (number2 + 1) + " is more expensive than Pet " + (number1 + 1) + " by $" + (price2 - price1));
                    } else {
                        System.out.println("The price of the two pets selected are equal");
                    }
                    break;
